...
def create_checkout_session():
    ...
    Do NOT overwrite latest_code here – that was causing everything
    to show the default Medium-Medium-Medium-Medium-Medium.
    """
    ...
    try:
        stripe_session = stripe.checkout.Session.create(
            ...
            success_url=f"{DOMAIN}/purchase-success?uid={user_id}",
            cancel_url=f"{DOMAIN}/"
        )
